<%-- 
    Document   : viewCart
    Created on : 09-Mar-2022, 16:01:09
    Author     : HTN
--%>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <table>
                                ...
                                <form action="MainController">
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" name="quantity" value="<%= product.getQuantity()%>" min="1" max="20"/>                       
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="shoping__cart__btns">
                                        <button type="submit" name="action" value="Edit" class="primary-btn cart-btn cart-btn-right"> 
                                            <span class="icon_loading"></span>
                                            Update Cart
                                        </button>
                                    </td>
                                    <td class="shoping__cart__item__close">
                                        <button type="submit" name="action" value="Remove"><span class="icon_close"></span></button>
                                    </td>   
                                    </tr>
                                </form>
                                <%          }
                    ...
                    <div class="col-lg-6">
                        ...
                        %>
                        <a href="MainController?action=Checkout" class="primary-btn-a">PROCEED TO CHECKOUT</a>
